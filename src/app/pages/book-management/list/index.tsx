...
import BookTable from "@/components/pages/book-management/BookTable";

export default function BookList() {
  return (
    <div>
      <div className="flex justify-between">
        <h1 className="text-xl font-bold uppercase mb-4">Books</h1>
      </div>
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="flex flex-col justify-between gap-5 border-b border-gray-200 p-4 sm:flex-row sm:items-center dark:border-gray-800">
          <div>
            <h2 className="text-xl font-bold uppercase">Books List</h2>
            <span className="text-sm text-gray-500 dark:text-gray-400">
              Manage all system books.
            </span>
          </div>
